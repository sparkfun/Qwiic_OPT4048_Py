...
class QwOpt4048:
    ...
    opt4048_reg_thresh_exp_res_low = OPT4048_Registers.opt4048_reg_thresh_exp_res_low_t()
    opt4048_reg_thresh_exp_res_high = OPT4048_Registers.opt4048_reg_thresh_exp_res_high_t()
    ...
    def get_device_id(self):
        ...
        unique_id = self._i2c.readWord(self.address, OPT4048_Registers.SFE_OPT4048_REGISTER_DEVICE_ID)

        return unique_id

    def set_basic_setup(self):
        self.set_range(OPT4048_Registers.opt4048RangeT.RANGE_36LUX)
        self.set_conversion_time(OPT4048_Registers.opt4048ConversionTimeT.CONVERSION_TIME_200MS)
        self.set_operation_mode(OPT4048_Registers.opt4048OperationModeT.OPERATION_MODE_CONTINUOUS)

    def set_range(self, range):

        reg = self._i2c.readWord(self.address, OPT4048_Registers.SFE_OPT4048_REGISTER_CONTROL)

        self.opt4048_reg_control.word = reg 
        self.opt4048_reg_control.range = range 

        self._i2c.writeWord(self.address, OPT4048_Registers.SFE_OPT4048_REGISTER_CONTROL, self.opt4048_reg_control.word)
    ...
    def set_conversion_time(self, time):
        ...
        control_reg.word = self._i2c.readWord(self.address, OPT4048_Registers.SFE_OPT4048_REGISTER_CONTROL)

        control_reg.conversion_time = time

        self._i2c.writeWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_CONTROL, control_reg.word)
    ...
    def set_int_input(self, enable):
        ...
        int_control_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_INT_CONTROL)

        int_control_reg.int_dir = enable

        self._i2c.writeWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_INT_CONTROL, int_control_reg.word)
    ...
    def get_all_flags(self):
        ...
        flag_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_FLAGS)
    ...
    def set_threshold_low(self, thresh):
        ...
        thresh_reg.word = self._i2c.readWord(self.address, OPT4048_Registers.SFE_OPT4048_REGISTER_THRESH_L_EXP_RES) 
        
        thresh_reg.thresh_exp = thresh

        self._i2c.writeWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_THRESH_L_EXP_RES, thresh_reg.word)
    ...
    def set_threshold_high(self, thresh):
        ...
        thresh_reg.word = self._i2c.readWord(self.address, OPT4048_Registers.SFE_OPT4048_REGISTER_THRESH_H_EXP_RES) 
        
        thresh_reg.thresh_exp = thresh

        self._i2c.writeWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_THRESH_H_EXP_RES, thresh_reg.word)
    ...
    def get_adc_ch0(self):
        ...
        adc_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_EXP_RES_CH0)
        adc1_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_RES_CNT_CRC_CH0)
    ...
    def get_adc_ch1(self):
        ...
        adc_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_EXP_RES_CH1)
        adc1_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_RES_CNT_CRC_CH1)
    ...
    def get_adc_ch2(self):
        ...
        adc_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_EXP_RES_CH2)
        adc1_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_RES_CNT_CRC_CH2)
    ...
    def get_adc_ch3(self):
        ...
        adc_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_EXP_RES_CH3)
        adc1_reg.word = self._i2c.readWord(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_RES_CNT_CRC_CH3)
    ...
    def get_all_channel_data(self, color):
        ...
        buff = self._i2c.readBlock(self.address,OPT4048_Registers.SFE_OPT4048_REGISTER_EXP_RES_CH0, 16)
